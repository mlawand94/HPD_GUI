                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" last"><button type="button" style="background-color: green" class="btn btn-info btn-xs fa fa-user-plus"  data-backdrop="static" id="1"> Authorized Docs.</button>
