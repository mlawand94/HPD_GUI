...
//                             </div> -->
                          ...
                          credentialDocs += '</td>';
                          credentialDocs += '<td>';
                          credentialDocs += '<button type="button" onclick="selectedDocument('+qd.document_id+')" class="btn btn-success btn-xs fa fa-folder" data-toggle="modal" data-target="#myModal"  data-backdrop="static" id="'+qd.document_id+' "> View</button>';
                            // credentialDocs += '<button type="button" onclick="" class="btn btn-success btn-xs fa fa-folder" data-toggle="modal" data-target="#myModal" '+qd.document_id+'> View</button>';
                            credentialDocs += '<button type="button" onclick="uploadDocModal('+qd.document_id+')" class="btn btn-info btn-xs fa fa-pencil" data-toggle="modal" data-target="#uploadDocModal" data-backdrop="static" id="'+qd.document_id+'"> Upload</button>';
